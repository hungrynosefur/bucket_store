...
-- Brand 테이블에 브랜드 정보 추가
INSERT INTO Brand (brand_id, brand_name, shipping_fee)
VALUES (1, 'Brand A', 10.00);

INSERT INTO Brand (brand_id, brand_name, shipping_fee)
VALUES (2, 'Brand B', 12.50);

INSERT INTO Brand (brand_id, brand_name, shipping_fee)
VALUES (3, 'Brand C', 9.99);

-- Product 테이블에 상품 정보 추가 (Brand A의 제품)
INSERT INTO Product (product_code, product_name, category, color, brand_id, product_option, size, price)
VALUES ('PROD1234-RED', 'Product A', 'Electronics', 'Red', 1, 'Model A', 'M', 99.99);

-- Product 테이블에 상품 정보 추가 (Brand B의 제품)
INSERT INTO Product (product_code, product_name, category, color, brand_id, product_option, size, price)
VALUES ('PROD5678-BLK', 'Product B', 'Clothing', 'Black', 2, 'Model X', 'L', 49.99);

-- Product 테이블에 상품 정보 추가 (Brand C의 제품)
INSERT INTO Product (product_code, product_name, category, color, brand_id, product_option, size, price)
VALUES ('PROD9876-WHT', 'Product C', 'Books', 'White', 3, 'Model Z', 'S', 29.99);
